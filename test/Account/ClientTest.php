...
class ClientTest extends TestCase
{
    ...
    public function testCreateSecretsValidationError()
    {
        try {
            ...
            $this->assertEquals('Bad Request: The request failed due to validation errors. See https://developer.Vonage.com/api-errors/account/secret-management#validation for more information', $e->getMessage());
