...
class Client implements ClientAwareInterface, APIClient
{
     ...
     * @param array $options Additional options, see https://developer.Vonage.com/api/numbers#getAvailableNumbers
     */
     ...
     * @param array $options Additional options, see https://developer.Vonage.com/api/numbers#getOwnedNumbers
     */
